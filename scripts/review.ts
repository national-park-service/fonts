...
const SAMPLES: Record<FamilyId, Sample[]> = {
  ...
  'sequoia-sans': [
    { label: 'Hero', text: 'Sequoia Sans', size: 120 },
    { label: 'Pangram', text: 'YOSEMITE valley · est 1864 · Half Dome · Tioga Pass', size: 44 },
    { label: 'Caps', text: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', size: 40 },
    { label: 'Lowercase', text: 'abcdefghijklmnopqrstuvwxyz', size: 40 },
    { label: 'Digits & punctuation', text: '0123456789 & — .,!?()/', size: 40 },
  ],
  'switchback': [
    { label: 'Hero', text: 'SWITCHBACK', size: 120 },
    { label: 'Pangram', text: 'NORTH RIM · 7100 FT · NEXT WATER 4 MI', size: 44 },
    { label: 'Caps', text: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', size: 40 },
    { label: 'Digits & punctuation', text: '0123456789 & — .,!?()/', size: 40 },
  ],
}
